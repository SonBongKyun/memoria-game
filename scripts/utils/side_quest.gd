...
const QUESTS: Array = [
	...
	},
	{
		...
		"prereq_flag": "",
		"steps": [
			{"flag": "sq_echo_fragments_started", "desc": "Search the Seam Outskirts for echo shards."},
			{"flag": "sq_echo_frag1", "desc": "Find the first echo shard near the cliff."},
			{"flag": "sq_echo_frag2", "desc": "Find the second echo shard in the ruins."},
			{"flag": "sq_echo_complete", "desc": "Return to the resonance point."},
		],
		"reward_grains": 80,
	...
	},
	{
		...
		"prereq_flag": "",
		"steps": [
			{"flag": "sq_forest_parasite_started", "desc": "Search the Forgotten Forest for parasitic vines."},
			{"flag": "sq_parasite_found", "desc": "Find the parasitic vine cluster."},
			{"flag": "sq_parasite_burned", "desc": "Burn a memory to purge the root."},
			{"flag": "sq_parasite_complete", "desc": "Confirm the vines have withered."},
		],
		"reward_grains": 100,
	...
	},
	{
		...
		"steps": [
			{"flag": "sq_colorless_compass_started", "desc": "Begin compass calibration."},
			{"flag": "sq_compass_anchor1", "desc": "Find the northern anchor point."},
			{"flag": "sq_compass_anchor2", "desc": "Find the eastern anchor point."},
			{"flag": "sq_compass_calibrated", "desc": "Calibrate the compass at the center."},
		],
		"reward_grains": 120,
