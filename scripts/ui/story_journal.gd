...
const EVENT_ENTRIES := [
	...
	{"flag": "ch3_tobias_met", "chapter": 3, "title": "Tobias Crane", "desc": "A Bureau Recorder with ink-stained fingers. Twenty years of memory transactions. He sees things others don't."},
	{"flag": "has_blank_book", "chapter": 3, "title": "The Blank Book", "desc": "Record-tree fiber. It absorbs the shape of memories — the contour remains even after the memory burns."},
	...
	{"flag": "ch4_anchoring", "chapter": 4, "title": "Anchoring Session", "desc": "Warm hands. The smell of bread. A page pressed back into its binding. Elia tethers the architecture."},
	...
	{"flag": "ch5_kairos_seen", "chapter": 5, "title": "Kairos Observed", "desc": "A figure on the ridge. Still as stone. Not chasing — classifying. Elia said that was worse."},
	{"flag": "elia_separates", "chapter": 5, "title": "Elia Took the Coastal Path", "desc": "To split Kairos's attention, Elia went south alone. Without her, burned memories would leave no residue. Just absence."},
...
const NPC_ENTRIES := [
	...
	{"flag": "ch3_tobias_met", "name": "Tobias Crane", "role": "Bureau Recorder / Class C",
